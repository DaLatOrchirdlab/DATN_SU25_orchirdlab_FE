...
const CreateExperimentStep1 = () => {
  ...
  const batches = [
    {
      id: "batch-001",
      name: "Batch-001 (Room A1)",
      status: "Active",
      samples: 12,
    },
    {
      id: "batch-002",
      name: "Batch-002 (Room B2)",
      status: "Active",
      samples: 8,
    },
    {
      id: "batch-003",
      name: "Batch-003 (Room C3)",
      status: "Completed",
      samples: 15,
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow">
                  ...
                  {selectedBatch && (
                    <div className="bg-orange-50 p-4 rounded-lg">
                      ...
                      <div className="text-sm text-orange-700 space-y-1">
                        <div>
                          <strong>Tên:</strong> Batch-001
                        </div>
                        <div>
                          <strong>Địa điểm:</strong> Room A1
                        </div>
                        <div>
                          <strong>Trạng thái:</strong> Active
                        </div>
                        <div>
                          <strong>Ngày tạo:</strong> 15/05/2025
                        </div>
                        <div>
                          <strong>Mẫu:</strong> 12 available
                        </div>
                      </div>
                    </div>
                  )}
            ...
            <div className="px-6 py-4 bg-gray-50 border-t flex justify-between">
              ...
              <div className="text-sm text-gray-500">* Trường bắt buộc</div>
            </div>
          </div>
        </div>
      </div>
