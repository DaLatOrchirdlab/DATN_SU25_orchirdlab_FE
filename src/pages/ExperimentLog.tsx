...
type ExperimentStatus = 'Active' | 'Completed' | 'In Progress' | 'Pending' | 'Failed';
...
const ExperimentLog = () => {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm(`Bạn có chắc chắn muốn xóa Experiment Log ${id} này không?`)) {
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-6 py-4">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-900">Experiment Log</h1>
            <Link 
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <div className="text-2xl font-bold text-green-700">{getStatusCount('Active') + getStatusCount('In Progress') + getStatusCount('Completed') + getStatusCount('Pending') + getStatusCount('Failed')}</div>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <div className="text-2xl font-bold text-purple-700">{getStatusCount('Completed')}</div>
            </div>
            <div className="bg-red-50 p-4 rounded-lg">
              <div className="text-red-600 text-sm font-medium">THẤT BẠI</div>
              <div className="text-2xl font-bold text-red-700">{getStatusCount('Failed')}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-6">
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 border-b">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Danh sách Experiment Logs</h2>
            ...
            <div className="flex gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  type="text"
                  placeholder="Tìm kiếm experiment logs..."
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">TISSUE CULTURE BATCH</th>
